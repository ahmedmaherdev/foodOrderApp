...
const address = elements.orderModal.querySelector('#address'),
  phoneNumber = elements.orderModal.querySelector('#phone-number');

export const postOrder = () => {
  if (validAddress() && validTelephone()) {
    if (
...
const addressError = document.querySelector('.order-address-error');
const phoneNumberError = document.querySelector('.order-phone-error');
const validAddress = () => {
  if (address.value) {
    return true;
  }
