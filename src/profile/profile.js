import { updateMainInfo, updatePassword, deleteProfile } from './updateProfile.js';

 export const UpdateCardcontainer = document.getElementById('insertUpdateCard')
...
const getUser = async token => {
  ...
  const {data : {data: res}} = await response.json()
  //  console.log(res);
   profile(res);
  // forwordData(result);
};
...
export const profile = profileData => {
    ...
    <div class="row m-l-0 m-r-0">
        ...
        <div class="col-sm-8">
            <div class="card-block">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <button type="button" class="btn btn-danger" id="updateProfile">Update Profile</button>
                    </div>
                    <div class="col-sm-4">
                      <button type="button" class="btn btn-danger" id="udpdatePassBtn">update Password</button>
                    </div>
                    <div class="col-sm-4">
  ...
  updateProfile.addEventListener('click', () => {
    updateMainInfo(UpdateCardcontainer, profileData)
  })
  ...
  udpdatePassBtn.addEventListener('click', () => {
    updatePassword(UpdateCardcontainer)
  })
